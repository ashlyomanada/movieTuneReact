      ...
      <div className="min-h-screen bg-[rgba(0,0,0,0.5)] flex justify-center">
        <div className="flex flex-col lg:flex-row justify-center items-center md:gap-4">
          ...
          <div className="text-white flex flex-col items-start w-full px-3 lg:px-0 lg:w-2/3">
            <h1 className="text-3xl font-bold">{details.original_name}</h1>
            <p className="mt-3">Overview: {details.overview}</p>
            ...
            <div className="flex gap-3 flex-wrap items-center mt-4">
              {details.Genres &&
                details.Genres.map((genre, index) => (
                  <span
                    key={index}
                    className="bg-[#1f1f1f] py-2 px-3 rounded-full text-white"
                  >
                    {genre}
                  </span>
                ))}
            ...
            <div className="flex gap-3 flex-wrap items-center mt-4">
              {seasons.map((seasons, index) => (
                <Link
                  ...
                  key={index}
                  className="bg-orange-700 py-2 px-3 rounded-full text-white no-underline"
                >
            ...
            <div className="flex gap-2 items-center pb-5">
              <button
                className="py-2 px-4 mt-4 rounded-md bg-[#1f1f1f] text-white"
                onClick={() => navigate(-1)}
              >
                Back
              </button>
